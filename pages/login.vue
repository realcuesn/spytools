    ...
    <div class="w-full lg:min-h-screen pt-44  lg:py-20 flex items-center justify-center px-5 xl:px-6 ">
        <div class="grid mx-auto items-center lg:grid-cols-2 max-w-7xl w-full">
            ...
            <div class="w-full text-white  ">
                <div class="text-left uppercase text-2xl text-[#f7ffdd]">Login to your Account</div>
                <div class="mt-10 w-full space-y-2">
                    <label class="block text-base uppercase" for="email">Your email</label>
                ...
                <div class="mt-5 w-full space-y-2">
                    <label class="block text-base uppercase" for="password">Your password</label>
                ...
                <div class="mt-4 text-lg mx-auto w-fit">
                    Don't have an account? <NuxtLink to="/register" class="text-[#F7FFDD] font-medium">Register</NuxtLink>
                </div>
                ...
                <div class="flex flex-col items-center mt-10 w-full gap-y-4">
                    ...
                    <button @click="loginGoogle"
                        ...
                        <span class="font-semibold">Login With With</span>
